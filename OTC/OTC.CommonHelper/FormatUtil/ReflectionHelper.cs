...
namespace OTC.CommonHelper.FormatUtil
{
    ...
    public static class ReflectionHelper
    {
            ...
            /// 获取程序集
            /// </summary>
            /// <param name="assemblyName">程序集路径</param>
            public static Assembly GetAssemblyByFile(string assemblyFile)
            {
            ...
            public static Type GetType(string assemblyFilePath, string className)
            {
                return Assembly.LoadFrom(assemblyFilePath).GetType(className);
                //return Assembly.Load(new AssemblyName(assemblyFilePath)).GetType(className);
            }
